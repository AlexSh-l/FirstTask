package com.alex.firsttask.filereader.implementation;

import com.alex.firsttask.exception.FileReaderException;
import com.alex.firsttask.filereader.ICustomFileReader;
...
public class CustomFileReader implements ICustomFileReader {
    ...
    public Optional<List<String>> readFile() throws FileReaderException {
        ...
        try (BufferedReader bufferedReader = Files.newBufferedReader(Paths.get(DEFAULT_FILE_PATH))) {
            List<String> fileContentList = bufferedReader.lines().collect(Collectors.toList());
